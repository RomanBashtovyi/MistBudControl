...
export const SPECIALIZATIONS = [
  ...
  {
    title: 'Обслуговування автотранспорту',
    percentage: '20%',
    description:
...
export const BENEFITS = [
  {
    ...
    description:
      'Ми забезпечуємо прозору та ефективну взаємодію — від формування концепції до впровадження сучасних рішень і надійного контролю.',
  },
  {
...
export const SECTION_HEADINGS = {
  ...
  specializations: {
    title: "Широкий спектр об'єктів",
    description:
      'Працюємо з ключовими галузями реального сектору та знаємо, як адаптувати інженерні рішення під вимоги виробництв різного масштабу.',
  },
  partners: {
    title: 'Наші партнери',
    description:
      '100+ клієнтів довіряють нашим архітекторам уже понад 12 років завдяки точності проєктування та якісному супроводу.',
  },
  stats: {
    title: {
      part1: 'Досвід і ',
  ...
  technologies: {
    title: {
      part1: 'Сучасні технології ',
      part2: 'автоматизації',
    },
    description:
      'Ми забезпечуємо повний супровід команди на всіх етапах проєкту — від впровадження BIM-концепцій і координації задач у системі Worksection до створення фінальної візуалізації.',
    integrationTitle:
      'Інтегруємо технології, процеси та команду',
  },
  contact: {
    title: 'Готові почати новий проєкт?',
    phoneLabel: 'Телефонуйте прямо зараз',
    emailLabel: 'Або напишіть на email',
  },
} as const
